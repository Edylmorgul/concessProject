...
/**
 * Servlet implementation class AjouterTypeInterventionPiece
 */
@WebServlet("/AjouterTypeInterventionPiece")
public class AjouterTypeInterventionPiece extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjouterTypeInterventionPiece() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			request.setAttribute("piecesAvec", piecesAvec);
			request.setAttribute("piecesSans", piecesSans);
			request.setAttribute("erreur", "Une erreur est survenue lors de la création du lien entre le type d'interventions et la pièce !");
			request.getRequestDispatcher("/Views/administrateur/piece.jsp").forward(request, response);
		}
	}
